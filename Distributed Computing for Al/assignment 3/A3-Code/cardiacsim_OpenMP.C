...
int main(int argc, char **argv)
{
	...
	for (int i = 0; i < m + 2; i++)
	{
		MPI_Bcast(E[i], n + 2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
		MPI_Bcast(E_prev[i], n + 2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
		MPI_Bcast(R[i], n + 2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
	}
	...
	MPI_Scatter(&E[1][0], interval, MPI_DOUBLE, my_E[1], interval, MPI_DOUBLE, 0, MPI_COMM_WORLD);
	MPI_Scatter(&E_prev[1][0], interval, MPI_DOUBLE, my_E_prev[1], interval, MPI_DOUBLE, 0, MPI_COMM_WORLD);
	MPI_Scatter(&R[1][0], interval, MPI_DOUBLE, my_R[1], interval, MPI_DOUBLE, 0, MPI_COMM_WORLD);
	...
	MPI_Gather(my_E_prev[1], interval, MPI_DOUBLE, &E_prev[1][0], interval, MPI_DOUBLE, 0, MPI_COMM_WORLD);
	MPI_Gather(my_E[1], interval, MPI_DOUBLE, &E[1][0], interval, MPI_DOUBLE, 0, MPI_COMM_WORLD);
	MPI_Gather(my_R[1], interval, MPI_DOUBLE, &R[1][0], interval, MPI_DOUBLE, 0, MPI_COMM_WORLD);
