...
# Compile the life program (adjust this line for your program's compilation)
gcc -o life life.c plot.c real_rand.c timer.c -fopenmp

# Output file
output_file="omp_with_display_bash_results.txt"
...
do
    ...
    do
        ...
        echo "Running with display - Size: $size, Threads: $threads" >> $output_file
...
echo "All simulations with display completed."
