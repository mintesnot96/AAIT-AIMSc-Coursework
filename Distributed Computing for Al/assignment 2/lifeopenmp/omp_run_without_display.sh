...
gcc -o life life.c plot.c real_rand.c timer.c -fopenmp

# Output file
output_file="results_openmp_without_display.txt"
...
do
    ...
    do
        ...
        echo "Running OpenMP without display - Size: $size, Threads: $threads" >> $output_file

        # Construct the command (with '-d' flag for disabling display)
        cmd="./life -s 1234 -n $size -i 500 -p 0.5 -t $threads -g 0 -d"
...
echo "All OpenMP simulations without display completed."
