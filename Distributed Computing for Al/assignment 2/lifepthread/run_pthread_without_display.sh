...
# Output file
output_file="results_pthread_without_display.txt"
...
do
    ...
    do
        ...
        echo "Running PThread without display - Size: $size, Threads: $threads" >> $output_file
...
echo "All PThread simulations without display completed."
